...
<html lang="en">
	...
	<body>
		...
		<div class="page-wrapper">
			...
			<!-- START HOME -->
			<section id="home" class="atf-header-area atf-align-items-details" data-stellar-background-ratio="0.3" style="background-color:#2E2E2E;  background-size:cover; background-position: center center;">
				<div class="container">
					<div class="row atf-content-details align-items-center justify-content-center">
						...
						<div class="col-xl-8 col-lg-7 col-12 atf-single-details text-center">
							...
							<div class="form-group col-md-12">
							    <p>Digite o email da sua conta para enviarmos um link de alteração de senha </p>
								<input type="text" name="name" class="form-control" id="name" placeholder="E-mail" required="required">
							</div>	
							<div class="atf-main-btn mt-3"> 
								<a href="https://www.templatemonster.com/landing-page-template/al-muhsi-multipurpose-landing-page-template-146026.html?_gl=1*1by1iar*_ga*MjgyMDU4MjUuMTYwODA1MDMzOQ..*_ga_FTPYEGT5LY*MTYwODA1NjEyNC4yLjEuMTYwODA1OTY1MS40OQ..&_ga=2.60495085.1397003643.1608056135-28205825.1608050339" class="page-scroll atf-themes-btn">Enviar <i class="fa fa-angle-right"></i></a>
							</div>
						</div><!--- END COL -->
					</div><!--- END ROW -->
				</div><!--- END CONTAINER -->
