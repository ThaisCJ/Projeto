...
<html lang="en">
	...
	<body>
		...
		<div class="page-wrapper">
			...
			<!-- START HOME -->
			<section id="home" class="atf-header-area1 atf-align-items-details" data-stellar-background-ratio="0.3" style="background-color:#2E2E2E;  background-size:cover; background-position: center center;">
				<div class="container">
					<div class="row atf-content-details align-items-center justify-content-center">
						...
						<div class="col-xl-8 col-lg-7 col-12 atf-single-details text-center">
							...
							<form method="POST" action="processa.php">
								...
								<div class="form-group col-md-12">
									<input type="text" name="email" class="form-control" id="name" placeholder="E-mail" maxlength="40" required="required">
								</div>
								<div class="form-group col-md-12">
								...
								<div>
									...
									<a href = "file:///C:/xampp/htdocs/Main%20File/muhsi/TermosServicos.html" >Clique aqui para ler os Termos de Serviços </a>	
								</div>
								<div>
